      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <form onSubmit={handleSubmit} className="glass-panel rounded-[2rem] p-8 sm:p-10">
          <div className="grid gap-4 md:grid-cols-2">
            <input value={form.fullName} onChange={(e) => setForm({ ...form, fullName: e.target.value })} placeholder="To‘liq ism" className="input-shell" required />
          ...
          <input value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })} placeholder="Mavzu" className="input-shell mt-4" required />
          <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} rows="6" placeholder="Xabar" className="input-shell mt-4" required />
